...
ErrorViewPanel::ErrorViewPanel(wxWindow* parent) :
    ViewPanel(parent, "错误处理视图") {
    ...
    viewSizer->Add(radio = new wxRadioBox(this, wxID_ANY, "处理方式",
        wxDefaultPosition, wxDefaultSize, 2, chioces), 0, wxALL, 5);

    viewSizer->Add(new wxStaticText(this, wxID_ANY, "重定向URL:"), 0, wxALL, 5);
    viewSizer->Add(redirect = new wxTextCtrl(this, wxID_ANY, ""),
        0, wxLEFT | wxRIGHT | wxEXPAND, 5);
